...
map.getView().fit([-10745703.430120, 1963113.978907, -10745024.810970, 1963508.494227], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">CROQUIS CATASTRAL DE SANTA MARÍA JALTIANGUIS</h2>';
        return titleElement;
    })(),
